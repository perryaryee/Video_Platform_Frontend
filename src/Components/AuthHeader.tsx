...
export const AuthHeader: React.FC<Props> = ({ showLogins, showLogout }) => {
                ...
                {showLogins ?
                    ...
                    showLogout ?
                        <div className=' flex items-center space-x-3'>
                            ...
                            <Button onClick={() => {
                                navigate("/")
                            }} style={{ backgroundColor: "#703578", color: "white", paddingLeft: 50, paddingRight: 50, borderRadius: 6, paddingTop: 13, paddingBottom: 13, fontWeight: "bold", fontSize: 13 }}>LOGOUT</Button>
                        </div>
                        :
                        <div className=' flex items-center space-x-3'>
                            <Button onClick={() => {
